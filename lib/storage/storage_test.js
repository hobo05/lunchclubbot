...
var testStorageMethod = function(storageMethod) {
    console.log("model name: " + storageMethod.model.modelName);
    var curSchema = storageMethod.model.schema;
    curSchema.add({foo: 'string'});
...
// Test mongo_storage
var mongo_storage = require('./mongo_storage.js')({url: 'mongodb://dbuser:dbuser@ds129459.mlab.com:29459/lunchclubdb'});
